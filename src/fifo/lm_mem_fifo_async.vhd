...
--=============================================================================
-- Module Name : lm_mem_fifo_async
-- Library     : -
-- Project     : lm_memories
-- Company     : LogiMentor Srl
-------------------------------------------------------------------------------
-- Description:
--  Asynchronous FIFO wrapper around lm_mem_fifo.
--  Uses the tested FIFO core with g_dual_clock set to true.
-------------------------------------------------------------------------------

library ieee;
use ieee.std_logic_1164.all;

entity lm_mem_fifo_async is
  generic(
...
end entity lm_mem_fifo_async;

architecture a_rtl of lm_mem_fifo_async is
begin
